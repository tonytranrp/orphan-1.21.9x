...
public:
    ...
    NumberSetting mAPS = NumberSetting("APS", "The attack per second of the aura.", 20.f, 1.f, 20.f, 0.1f);
    NumberSetting mRange = NumberSetting("Range", "The range of the aura.", 70.f, 3.f, 100.f, 1.f);
    ...
    NumberSetting mBlocksPerPacket = NumberSetting("Blocks Per Packet", "The amount of blocks to send per packet.", 0.5f, 0.1f, 3.f, 0.1f);
