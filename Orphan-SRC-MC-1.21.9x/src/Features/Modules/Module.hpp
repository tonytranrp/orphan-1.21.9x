...
public:
    ...
    KeybindSetting mKeybindSetting = KeybindSetting("Bind", "Keybind for this module", 0);
    ...
    float cFade = 0;
    float cScale = 0;
    float symbolAnim = 0.f;  // Animation value for transitioning between + and -
