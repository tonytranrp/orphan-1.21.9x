...
public:
    ...
    NumberSetting mSprintSpeed = NumberSetting("Speed with sprint", "speed in air while sprinting", 1.0f, 1.f, 5.0f, 0.1f);
    NumberSetting mNoSprintSpeed = NumberSetting("Speed without sprint", "speed in air while not sprinting", 1.0f, 1.f, 5.0f, 0.1f);
