...
{
public:
    DividerSetting dClient = DividerSetting("- Client -", "Settings for showing client info");
    ...
    DividerSetting dPlayer = DividerSetting("- Player -", "Settings for showing player info");
    ...
    DividerSetting dInventory = DividerSetting("- Inventory -", "Settings for showing inventory info");
