...
#include "Hooks/RenderHooks/PanoramaReplace.hpp"
#include "Hooks/ActorHooks/NametagRenderHook.hpp"
#include "Hooks/RenderHooks/BaseLightTextureImageBuilderHook.hpp"
...
void HookManager::init(bool initLp)
{
    ...
    else
    {
        ...
        ADD_HOOK(PanoramaReplace);
        ADD_HOOK(BaseLightTextureImageBuilderHook);
