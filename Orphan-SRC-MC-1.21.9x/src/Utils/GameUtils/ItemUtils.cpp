...
bool ItemUtils::isArrow(ItemStack* stack) {
    if (!stack || !stack->mItem) return false;
    return StringUtils::containsIgnoreCase(stack->getItem()->mName, "arrow");
}

bool ItemUtils::isBow(ItemStack* stack) {
    if (!stack || !stack->mItem) return false;
    return StringUtils::containsIgnoreCase(stack->getItem()->mName, "bow");
}

bool ItemUtils::isCrumblingCobblestone(ItemStack* stack) {
    if (!stack || !stack->mItem) return false;
    return StringUtils::containsIgnoreCase(stack->getItem()->mName, "crumbling");
}

bool ItemUtils::isEnderPearl(ItemStack* stack) {
    if (!stack || !stack->mItem) return false;
    return StringUtils::containsIgnoreCase(stack->getItem()->mName, "ender_pearl");
}

bool ItemUtils::isGoldenApple(ItemStack* stack) {
    if (!stack || !stack->mItem) return false;
    return StringUtils::containsIgnoreCase(stack->getItem()->mName, "golden_apple");
}

bool ItemUtils::isSnowball(ItemStack* stack) {
    if (!stack || !stack->mItem) return false;
    return StringUtils::containsIgnoreCase(stack->getItem()->mName, "snowball");
}