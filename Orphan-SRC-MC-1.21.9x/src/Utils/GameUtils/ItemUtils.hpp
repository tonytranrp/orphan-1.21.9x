...
public:
    ...
    static bool isBow(ItemStack* stack);
    static bool isCrumblingCobblestone(ItemStack* stack);
    static bool isEnderPearl(ItemStack* stack);
    static bool isGoldenApple(ItemStack* stack);
    static bool isSnowball(ItemStack* stack);
};